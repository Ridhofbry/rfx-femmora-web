...
import { Bot, X, Send } from 'lucide-react'; // Hapus Sparkles, pastikan Bot ada
...
const AIChatBot = () => {
  ...
  const handleSend = async (e) => {
    ...
    const prompt = `Kamu adalah Rexa, asisten virtual ramah dan gaul untuk RFX Femmora. Jawablah: "${userMsg}"`;
  ...
  return (
    <>
      {/* TOMBOL FLOATING - DENGAN IKON ROBOT (Bot) */}
